...
var _roblablaReactTweenState = require('@roblabla/react-tween-state');

var _roblablaReactTweenState2 = _interopRequireDefault(_roblablaReactTweenState);
...
var Carousel = _react2['default'].createClass({
  ...
  mixins: [_roblablaReactTweenState2['default'].Mixin],
    ...
    if (this.touchObject.length > this.state.slideWidth / this.props.slidesToShow / 5) {
      if (this.touchObject.direction === 1) {
        if (this.state.currentSlide >= _react2['default'].Children.count(this.props.children) - this.props.slidesToShow) {
          this.animateSlide(_roblablaReactTweenState2['default'].easingTypes[this.props.edgeEasing]);
        } else {
          this.nextSlide();
        }
  ...
  animateSlide: function animateSlide(easing, duration, endValue) {
    this.tweenState(this.props.vertical ? 'top' : 'left', {
      easing: easing || _roblablaReactTweenState2['default'].easingTypes[this.props.easing],
